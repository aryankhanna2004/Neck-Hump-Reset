        ...
        ZStack {
            ...
            VStack(spacing: 0) {
                ...
                VStack(spacing: AppTheme.Spacing.md) {
                    ForEach(Array(ScreenTime.allCases.enumerated()), id: \.element.id) { index, time in
                        SelectionCard(
                            icon: time.icon,
                            title: time.title,
                            subtitle: nil,
                            isSelected: viewModel.selectedScreenTime == time,
                            action: { viewModel.selectScreenTime(time) }
                        )
